        ...
        <div class="iq-card">
            <div class="iq-card-header d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Discound Product Table</h4>
                </div>
                <div>
                    <span class="table-add float-right mr-2">
                        <a href="{{ route('admin.discount_product.create') }}">
                        ...
                        <tbody>
                            @foreach($codes as $code)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.discount_product.edit', $code->id) }}">
                                            <button type="button" class="btn btn-warning mb-3">
                                                <i class="fa-regular fa-pen-to-square" style="margin: 0"></i>
                                            </button>
                                        </a>
                                        <a class="action_delete" data-url="{{ route('admin.discount_product.destroy', $code->id) }}">
