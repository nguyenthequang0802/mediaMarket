            ...
            <form action="{{ route('admin.product.update', $item->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm mb-3" id="discount" name="discount">
                        ...
                        @include('admin.content.product.discount_option_selected', ['discounts' => $discounts, 'item' => $item])
                    </select>
                    @if ($errors->has('status'))
                        <div class="alert alert-danger mt-2" role="alert">
                            <div class="iq-alert-icon">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm mb-3" id="category" name="category">
                        @include('admin.content.product.category_option_selected', ['categories' => $categories, 'item' => $item])
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm mb-3" id="brand" name="brand">
                        @include('admin.content.product.brand_option_selected', ['brands' => $brands, 'item' => $item])
                    </select>
                    @if ($errors->has('brand'))
                        <div class="alert alert-danger mt-2" role="alert">
                            <div class="iq-alert-icon">
                            ...
                            <div class="iq-alert-text">{{ $errors->first('brand') }}!</div>
                        </div>
                    @endif
                </div>
