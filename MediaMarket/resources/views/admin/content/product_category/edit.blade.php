    ...
    <div class="col-lg-12">
        <div class="iq-card">
            ...
            <div class="iq-card-body">
                <form action="{{route('admin.product_category.edit', $item->id)}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm mb-3" id="ParentId" name="ParentId">
                            ...
                            @include('admin.content.product_category.edit_category_selected', ['categories'=>$categories, 'level'=>0])
                        </select>
                    </div>
