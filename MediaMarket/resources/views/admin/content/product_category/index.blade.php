            ...
            <div class="iq-card-body">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                           @include('admin.content.product_category.row_table', ['categories'=>$categories, 'level'=>0])
                        </tbody>
                    </table>
                </div>
            </div>
        </div>
        <div class="d-flex justify-content-center">{{$categories->links('vendor.pagination.bootstrap-5')}}</div>
    </div>
@endsection
@section('customjs')
